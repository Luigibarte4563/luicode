...
FEATURE_INVENTORY: tuple[FeatureCoverage, ...] = (
    FeatureCoverage(
        ...
        (
            "Codex executable",
            "LUICODE_SMOKE_CODEX_FREE_MODEL and OpenRouter key for optional live inference",
        ),
    ...
    FeatureCoverage(
        ...
        "missing providers are missing_env unless LUICODE_ALLOW_NO_PROVIDER_SMOKE=1",
    ),
    FeatureCoverage(
        ...
        (
            "configured provider",
            "LUICODE_SMOKE_CLAUDE_BIN for real Claude CLI",
            "NVIDIA_NIM_API_KEY",
            "OPENROUTER_API_KEY",
        ),
    ...
    FeatureCoverage(
        ...
        ("cli",),
        ("Claude CLI", "LUICODE_SMOKE_MODEL_OPENAI and connected OpenAI account"),
    ...
    FeatureCoverage(
        "pi_cli_integration",
        "Pi discovers LUICODE models and sends Anthropic Messages through the proxy",
        ("tests/cli/test_entrypoints.py",),
        ("test_probe_and_models_routes",),
    ...
    FeatureCoverage(
        ...
        "OpenCode discovers LUICODE models and sends Responses through the proxy",
        (
    ...
    FeatureCoverage(
        ...
        "Aider discovers LUICODE models and sends Anthropic Messages through the proxy",
        (
    ...
    FeatureCoverage(
        ...
        "Cline discovers LUICODE models and sends Responses through the proxy",
        (
    ...
    FeatureCoverage(
        ...
        "Hermes discovers LUICODE models and sends Responses through the proxy",
        (
    ...
    FeatureCoverage(
        "dsh_cli_integration",
        "DeepSeek Harness discovers LUICODE models and sends Responses through the proxy",
        (
    ...
    FeatureCoverage(
        ...
        "Grok Build discovers LUICODE models and sends Responses through the proxy",
        (
    ...
    FeatureCoverage(
        ...
        "Muse Code discovers LUICODE models and sends Responses through the proxy",
        (
    ...
    FeatureCoverage(
        ...
        ("providers",),
        ("configured provider credentials/endpoints", "optional LUICODE_SMOKE_MODEL_*"),
    ...
    FeatureCoverage(
        ...
        ("nvidia_nim_vision",),
        ("NVIDIA_NIM_API_KEY", "LUICODE_SMOKE_MODEL_NVIDIA_NIM_VISION"),
    ...
    FeatureCoverage(
        ...
        ("messaging", "voice"),
        ("VOICE_NOTE_ENABLED", "LUICODE_SMOKE_RUN_VOICE", "WHISPER_DEVICE"),
