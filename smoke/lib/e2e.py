...
from luicode.config.provider_catalog import SUPPORTED_PROVIDER_IDS
...
from luicode.messaging.voice import VoiceCancellationResult
...
class ConversationDriver:
    ...
    def ask(
        ...
        text: str,
        *,
        model: str = "luicode-smoke-default",
        max_tokens: int = 256,
...
class ProviderMatrixDriver:
    ...
    def provider_smoke_models(self) -> list[ProviderModel]:
        ...
        if not models and os.getenv("LUICODE_ALLOW_NO_PROVIDER_SMOKE") != "1":
            fail_missing_env(
                "no configured provider smoke models; set LUICODE_ALLOW_NO_PROVIDER_SMOKE=1 "
    ...
    def adaptive_thinking_payload() -> dict[str, Any]:
        return {
            ...
            "messages": [
                ...
                {"role": "user", "content": "Reply with exactly LUICODE_SMOKE_CLIENT"},
            ],
                    ...
                    "content": [
                        {
                            ...
                            "name": "echo_smoke",
                            "input": {"value": "LUICODE_SMOKE_CLIENT"},
                        }
                    ],
                },
                {
...
class FakePlatform:
    ...
    def continue_message_sequence_after(self, previous: FakePlatform) -> None:
        """Model platform-owned message IDs surviving an LUICODE restart."""
