...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    CapabilityContract(
        ...
        "code_session_modes",
        "luicode.application.code_sessions.service.CodeService",
    ...
    CapabilityContract(
        ...
        "luicode.api.handlers.messages.MessagesHandler",
    ...
    CapabilityContract(
        ...
        "luicode.api.handlers.responses.ResponsesHandler",
    ...
    CapabilityContract(
        ...
        "luicode.api.dependencies.require_proxy_auth",
    ...
    CapabilityContract(
        ...
        "provider_runtime",
        "provider_matrix",
        "luicode.runtime.provider_manager.ProviderRuntimeManager",
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "luicode.application.routing.ModelRouter",
    ...
    CapabilityContract(
        ...
        "model_fallback",
        "luicode.application.execution.ProviderExecutor",
    ...
    CapabilityContract(
        ...
        "luicode.providers.runtime.ProviderRuntime",
    ...
    CapabilityContract(
        ...
        "luicode.core.failures.ExecutionFailure",
    ...
    CapabilityContract(
        ...
        "luicode.core.anthropic.thinking",
    ...
    CapabilityContract(
        ...
        "luicode.core.anthropic and luicode.core.openai_responses",
    ...
    CapabilityContract(
        ...
        "subagent_control",
        "luicode.core.anthropic.streaming.AnthropicStreamLedger",
    ...
    CapabilityContract(
        ...
        "luicode.api.optimization_handlers",
    ...
    CapabilityContract(
        ...
        "luicode.core.anthropic.get_token_count",
    ...
    CapabilityContract(
        ...
        "luicode.config.loader.get_settings",
    ...
    CapabilityContract(
        ...
        "removed_env_migration",
        "luicode.config.env_migrations.consolidate_managed_config",
        "retired ENABLE_MODEL_THINKING or tier override in an LUICODE-owned dotenv",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "luicode.providers.admission.ProviderAdmissionController",
    ...
    CapabilityContract(
        ...
        "lmstudio_messages",
        "lmstudio_endpoint",
        "luicode.providers.lmstudio.LMStudioProvider",
    ...
    CapabilityContract(
        ...
        "llamacpp_endpoint",
        "luicode.providers.openai_chat.OpenAIChatProvider",
    ...
    CapabilityContract(
        ...
        "provider_matrix",
        "luicode.providers.open_router.OpenRouterProvider",
    ...
    CapabilityContract(
        ...
        "tree_threading",
        "tree_threading",
        "luicode.messaging.trees.TreeQueueManager",
    ...
    CapabilityContract(
        ...
        "restart_restore",
        "restart_restore",
        "luicode.messaging.session.SessionStore",
        "stored tree JSON",
    ...
    CapabilityContract(
        ...
        "voice_transcription",
        "voice_notes",
        "luicode.messaging.voice.Transcriber",
    ...
    CapabilityContract(
        ...
        (
            "test_luicode_server_entrypoint_starts_server",
    ...
    CapabilityContract(
        ...
        "claude_cli_drop_in",
        "claude_cli_drop_in",
        "luicode.cli.managed.session.ManagedClaudeSession",
    ...
    CapabilityContract(
        ...
        "codex_cli_drop_in",
        "drop_in_codex_replacement",
        "luicode.cli.launchers.codex",
        "Codex CLI binary and luicode provider env",
    ...
    CapabilityContract(
        ...
        "pi_cli_integration",
        "pi_cli_integration",
        "luicode.cli.launchers.pi",
        "Pi CLI binary, bundled extension, and LUICODE child-process environment",
        "Anthropic Messages provider with an LUICODE-scoped live model catalog",
    ...
    CapabilityContract(
        ...
        "opencode_cli_integration",
        "luicode.cli.launchers.opencode",
        "OpenCode 2 binary, live LUICODE model catalog, and child-process config",
        "Responses provider scoped to LUICODE with bearer authentication",
    ...
    CapabilityContract(
        ...
        "aider_cli_integration",
        "luicode.cli.launchers.aider",
        "Aider 0.86.2+, live LUICODE Messages catalog, and private process files",
        "Anthropic Messages route scoped to LUICODE for native Aider sessions",
    ...
    CapabilityContract(
        ...
        "cline_cli_integration",
        "luicode.cli.launchers.cline",
        "Cline binary, live LUICODE model catalog, and protected child-process files",
        "Responses provider scoped to LUICODE for attached local sessions",
    ...
    CapabilityContract(
        ...
        "hermes_cli_integration",
        "luicode.cli.launchers.hermes",
        "Hermes Agent 0.20.4+, live LUICODE catalog, and process-only managed overlay",
        "Responses provider scoped to LUICODE for attached terminal sessions",
    ...
    CapabilityContract(
        ...
        "dsh_cli_integration",
        "dsh_cli_integration",
        "luicode.cli.launchers.dsh",
        "DeepSeek Harness 0.1.0-rc.8, live LUICODE catalog, and process-only patch",
        "Responses provider scoped to LUICODE for attached Web and headless sessions",
    ...
    CapabilityContract(
        ...
        "grok_cli_integration",
        "luicode.cli.launchers.grok",
        "Grok Build 1.0.5+, live LUICODE Responses catalog, and child-only config",
        "Responses route scoped to LUICODE for native Grok sessions",
    ...
    CapabilityContract(
        ...
        "muse_cli_integration",
        "luicode.cli.launchers.muse",
        "Muse Code 0.2.1+, live LUICODE Responses catalog, and child-only route",
        "Responses route scoped to LUICODE for native Muse sessions",
    ...
    CapabilityContract(
        ...
        "luicode.providers.runtime and luicode.messaging.platforms.factory",
