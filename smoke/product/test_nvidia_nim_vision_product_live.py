...
from luicode.core.anthropic.stream_contracts import parse_sse_lines
...
_FIXTURE = Path(__file__).resolve().parents[1] / "assets" / "vision-luicode.png"
_VISIBLE_TOKEN = "K7P4"
...
def test_nvidia_nim_vision_tool_result_e2e(smoke_config: SmokeConfig) -> None:
    ...
    if provider_model is None:
        pytest.skip("missing_env: LUICODE_SMOKE_MODEL_NVIDIA_NIM_VISION is required")
                ...
                "content": [
                    {
                        ...
                        "id": "call_read_image",
                        "name": "Read",
                        "input": {"file_path": "vision-luicode.png"},
                    }
                ],
            },
            {
        ...
        "input": [
            {
                ...
                "name": "Read",
                "arguments": '{"file_path":"vision-luicode.png"}',
            },
            {
