...
from luicode.config.env_migrations import recognized_env_keys
...
def admin_base_url(
    ...
    monkeypatch.delenv("LUICODE_ENV_FILE", raising=False)
    ...
    monkeypatch.setenv("LUICODE_OPEN_BROWSER", "false")
    ...
    monkeypatch.setattr(
        "luicode.api.admin_routes._check_local_provider",
