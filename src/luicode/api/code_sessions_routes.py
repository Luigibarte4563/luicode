...
from luicode.application.code_sessions import (
    CodeApplicationPort,
    CodeDetail,
    CodeItem,
    CodePrompt,
...
from luicode.application.code_sessions.models import CodeMode
...
def _code(services: ApiServices) -> CodeApplicationPort:
    if services.code is None:
        raise CodeUnavailableError(
            "Code sessions is unavailable in this LUICODE runtime."
        )
