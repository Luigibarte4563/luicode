...
from luicode.application.errors import ApplicationError, InvalidRequestError
    ...
    async def create(
        ...
        if request_data.stream is False:
            raise InvalidRequestError(
                "LUICODE /v1/responses supports streaming only; omit stream or set stream=true."
            )
