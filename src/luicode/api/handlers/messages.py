...
from luicode.api.detection import detect_safety_classifier_stop_sequence
from luicode.api.optimization_handlers import try_optimizations
from luicode.api.request_errors import (
...
from luicode.api.request_ids import new_request_id
from luicode.api.response_streams import (
    EmptyStreamError,
...
class MessagesHandler:
    ...
    def _intercept_local_optimization(
        ...
        trace_event(
            stage="routing",
            event="luicode.api.optimization.short_circuit",
            source="api",
            model=routed.resolved.original_model,
        )
