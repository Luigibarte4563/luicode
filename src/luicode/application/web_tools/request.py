"""Recognize the narrow Anthropic web-tool requests LUICODE can execute locally."""

import re
from dataclasses import dataclass

from luicode.application.errors import InvalidRequestError
from luicode.core.anthropic import MessagesRequest, Tool

WEB_SEARCH_TYPE = "web_search_20250305"
WEB_FETCH_TYPE = "web_fetch_20250910"
HIDDEN_WEB_SEARCH_NAME = "luicode_web_search"
...
def unsupported_server_tool_error(
    ...
    """Return the user-facing error for a server-tool shape LUICODE does not handle."""
    ...
    if not forced and has_listed_anthropic_server_tools(request):
        return (
            "LUICODE supports automatic Anthropic web_search only for Claude Code's "
