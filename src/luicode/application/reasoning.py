"""Resolve client reasoning input and LUICODE configuration exactly once."""

from collections.abc import Mapping

from luicode.config.reasoning import ReasoningPreference
from luicode.core.anthropic.models import MessagesRequest, ThinkingConfig
...
def _apply_reasoning_preference(
    ...
    """Apply LUICODE's route preference to already-parsed client intent."""
