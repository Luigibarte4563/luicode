...
from luicode.core.trace import (
    close_stream_input,
    trace_event,
    traced_async_stream,
)
...
class ProviderExecutor:
    ...
    def _trace_fallback_selected(
        ...
        *,
        ...
        fields: dict[str, object] = {
            "stage": "execution",
            "event": "luicode.model_fallback.selected",
            "source": "application",
            "request_id": request_id,
            "wire_api": wire_api,
    ...
    def _stream_candidates(
        ...
        *,
        ...
        route_trace: dict[str, object] = {
            "stage": "routing",
            "event": "luicode.api.route.resolved",
            "source": "api",
            "request_id": request_id,
        ...
        ingress_trace: dict[str, object] = {
            "stage": "ingress",
            "event": (
                "luicode.api.responses.request.received"
                if wire_api == "responses"
                else "luicode.api.request.received"
            ),
            "source": "api",
        ...
        return traced_async_stream(
            ...
            source="api",
            complete_event=(
                "luicode.api.responses.stream_completed"
                if wire_api == "responses"
                else "luicode.api.response.stream_completed"
            ),
            interrupted_event=(
                "luicode.api.responses.stream_interrupted"
                if wire_api == "responses"
