...
from luicode.providers.failure_policy import provider_authentication_status
from luicode.providers.http import ProviderAttemptScope
from luicode.providers.model_listing import (
...
try:
    LUICODE_VERSION = version("luicode")
    ...
    def __init__(
        ...
        *,
        ...
        self._client_headers = {
            "User-Agent": f"{OPENAI_CODEX_ORIGINATOR}/{LUICODE_VERSION}",
            "originator": OPENAI_CODEX_ORIGINATOR,
            "version": LUICODE_VERSION,
        }
        self._pool = (
            transport
            ...
            while execution.can_attempt:
                ...
                try:
                    ...
                    payload = await client.get(
                        "models",
                        cast_to=object,
                        options={"params": {"client_version": LUICODE_VERSION}},
                    )
