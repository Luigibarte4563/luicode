"""Platform-neutral lifecycle for the LUICODE desktop shell."""
...
from luicode.cli.commands import (
    ServerStatus,
    ServerSupervisor,
...
class DesktopController:
    """Coordinate one tray loop with one in-process LUICODE server owner."""
    ...
    def run(self) -> None:
        """Run the tray on this thread and the LUICODE server on its owned worker."""
