"""Process-local Hermes configuration for LUICODE model routing."""
...
HERMES_PROVIDER_PREFIX = "luicode-"
HERMES_KEY_ENV_PREFIX = "LUICODE_HERMES_"
...
def build_hermes_managed_config(
    ...
    *,
    ...
    """Translate an LUICODE catalog into one invocation-specific Hermes overlay."""

    if not models:
        raise ValueError("Hermes requires at least one routable LUICODE model")
    ...
    config: JsonObject = {
        ...
        "model": {
            ...
            "default_headers": {"x-luicode-launch-id": nonce},
        },
        "fallback_providers": [],
        "fallback_model": [],
        "auxiliary": auxiliary,
