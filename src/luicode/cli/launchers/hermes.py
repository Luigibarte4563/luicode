...
def _configure(
    ...
    if os.name != "nt" and Path("/etc/hermes").exists():
        raise ValueError(
            "An existing Hermes managed policy cannot be replaced by LUICODE."
        )
    ...
    return PreparedLaunch(
        ...
        NativeCheck(
            ...
            "Could not activate the LUICODE Hermes managed provider.",
...
SPEC = HarnessSpec(
    ...
    compatibility_check=NativeCheck(
        ...
        "LUICODE requires Hermes 0.20.4 or newer.",
    ),
)
