"""Process-local DeepSeek Harness configuration for LUICODE model routing."""
...
DSH_API_KEY_ENV = "LUICODE_DSH_API_KEY"
DSH_ENV_PREFIX = "LUICODE_DSH_"
DSH_PROVIDER_ID = "luicode"
...
def build_dsh_launch_config(
    ...
    *,
    ...
    """Translate LUICODE's catalog and timeout into an isolated DSH overlay."""

    if not models:
        raise ValueError(
            "DeepSeek Harness requires at least one routable LUICODE model"
        )
