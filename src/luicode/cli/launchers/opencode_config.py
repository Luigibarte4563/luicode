"""Process-local OpenCode v2 configuration for LUICODE model routing."""
...
OPENCODE_API_KEY_ENV = "LUICODE_OPENCODE_API_KEY"
OPENCODE_PROVIDER_ID = "luicode"
...
def build_opencode_config(
    ...
    """Translate a non-empty LUICODE model snapshot into OpenCode v2 config."""

    if not models:
        raise ValueError("OpenCode requires at least one routable LUICODE model")
