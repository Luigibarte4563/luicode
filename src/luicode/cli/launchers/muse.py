"""Installed Muse Code launcher with a native LUICODE connection."""
...
_INSTALL_HINT = (
    ...
    'your-github-org/luicode/main/scripts/install-muse.ps1")))`, '
...
SPEC = HarnessSpec(
    ...
    compatibility_check=NativeCheck(
        ...
        "LUICODE requires Muse Code 0.2.1 or newer.",
    ),
)
