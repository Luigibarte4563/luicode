"""Process-local Aider configuration for LUICODE model routing."""

import re
from dataclasses import dataclass, field

from luicode.application.model_catalog import CatalogModel, model_order_key
from luicode.core.json_types import JsonObject
from luicode.core.model_capabilities import ModelInputModality

AIDER_API_KEY_ENV_PREFIX = "LUICODE_AIDER_PROXY_AUTH_"
...
def build_aider_config(
    ...
    *,
    ...
    """Project a non-empty LUICODE Messages catalog into Aider's file contracts."""

    if not models:
        raise ValueError("Aider requires at least one routable LUICODE model")
