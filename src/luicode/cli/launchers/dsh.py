"""Installed DeepSeek Harness launcher with an LUICODE connection patch."""
...
def _configure(
    ...
    patch_path = files.write_json("luicode.patch.yml", config)
...
SPEC = HarnessSpec(
    ...
    compatibility_check=NativeCheck(
        ...
        "LUICODE requires DeepSeek Harness 0.1.0-rc.8.",
    ),
)
