...
class ReasoningEffort(StrEnum):
    """Named reasoning effort understood at the LUICODE application boundary."""
    ...
    def budget_tokens(self) -> int:
        """Return LUICODE's numeric token budget for this effort."""
...
class ReasoningPolicy:
    ...
    def numeric_budget_tokens(self) -> int | None:
        """Express this intent as an exact or LUICODE-mapped numeric budget."""
