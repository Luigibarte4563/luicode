...
LUICODE_ENV_FILE_ENV = "LUICODE_ENV_FILE"
LUICODE_CONFIG_SCHEMA_ENV = "LUICODE_CONFIG_SCHEMA"
...
def legacy_explicit_env_path(
    ...
    value = source.get(LUICODE_ENV_FILE_ENV, "").strip()
...
def verified_checkout_env_path() -> Path | None:
    ...
    try:
        ...
        return None
    if 'name = "luicode"' not in project_text:
        return None
