...
from luicode.core.openai_responses import build_responses_chat_request
...
def test_anthropic_chat_output_preserves_existing_wire_lifecycle() -> None:
    ...
    frames.append(output.emit_tool_delta(0, '{"q":"luicode"}'))
    ...
    assert tool_block.content == '{"q":"luicode"}'
