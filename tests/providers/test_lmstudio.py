...
from luicode.config.provider_catalog import LMSTUDIO_DEFAULT_BASE
from luicode.core.anthropic import MessagesRequest, get_token_count
...
async def test_context_cache_expires_from_lookup_completion(monkeypatch):
    ...
    monkeypatch.setattr(
        "luicode.providers.lmstudio.client.time",
