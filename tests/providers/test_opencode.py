...
from luicode.providers.opencode import (
    OpenCodeProvider,
    create_opencode_provider,
)
from luicode.providers.opencode.catalog import (
...
def test_client_identifies_as_first_party_opencode_user_agent(
    ...
    with (
        patch("luicode.providers.openai_chat.client.AsyncOpenAI") as mock_openai,
