...
from luicode.config.provider_catalog import DEEPSEEK_DEFAULT_BASE
...
from luicode.core.openai_chat import is_synthetic_chat_tool_turn_boundary
...
def test_init(deepseek_config):
    with patch("luicode.providers.openai_chat.client.AsyncOpenAI") as mock_client:
