...
from luicode.messaging.limiter import MessagingRateLimiter
from luicode.messaging.platforms.telegram import TelegramRuntime


@pytest.fixture
def telegram_platform():
    with patch("luicode.messaging.platforms.telegram.TELEGRAM_AVAILABLE", True):
