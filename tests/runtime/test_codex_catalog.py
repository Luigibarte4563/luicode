...
from luicode.application.code_sessions.models import CodeValidationError
from luicode.application.model_metadata import ProviderModelInfo
from luicode.application.ports import (
...
from luicode.runtime.codex_catalog import (
...
def test_empty_projection_preserves_existing_catalog(tmp_path: Path) -> None:
    ...
    with (
        patch(
            "luicode.runtime.codex_catalog.build_codex_model_catalog",
            return_value={"models": []},
        ),
