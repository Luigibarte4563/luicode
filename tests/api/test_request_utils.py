...
from luicode.api.command_utils import extract_command_prefix
from luicode.api.detection import (
    is_prefix_detection_request,
    is_quota_check_request,
    is_title_generation_request,
)
from luicode.core.anthropic import get_token_count
...
class TestGetTokenCount:
    ...
    def test_known_payload_structural_overhead(self):
        ...
        with patch(
            "luicode.core.anthropic.tokens.estimate_text_tokens",
            side_effect=len,
        ):
