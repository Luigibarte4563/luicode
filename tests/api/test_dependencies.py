...
from luicode.api.dependencies import (
    get_services,
    get_settings,
...
from luicode.application.ports import RequestRuntimeLease
...
async def test_resolve_provider_uses_retained_lease_and_logs_first_initialization() -> (
    ...
    with patch("luicode.api.dependencies.logger.info") as log_info:
