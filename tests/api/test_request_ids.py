...
from luicode.api.request_ids import (
    RequestCorrelationMiddleware,
    get_request_id,
)
from luicode.api.request_lifetime import ClientRequestLifetimeMiddleware
...
async def test_correlation_context_and_headers_span_the_complete_stream() -> None:
    ...
    with patch(
        "luicode.api.request_ids.logger.contextualize",
