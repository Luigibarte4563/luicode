...
from luicode.core.anthropic.conversion import AnthropicToOpenAIConverter
...
from luicode.core.openai_responses.chat_request import (
...
from luicode.providers.deepseek.client import DeepSeekProvider
from luicode.providers.deepseek.compat import finalize_deepseek_chat_body
                                ...
                                "content": [
                                    {
                                        ...
                                        "data": "luicode:history:v2:unsupported",
                                    }
                                ],
                            }
                        ],
            ...
            provider.stream_responses(
                OpenAIResponsesRequest(
                    ...
                    input=[
                        {
                            "type": "reasoning",
                            "encrypted_content": "luicode:history:v2:unsupported",
                        }
                    ],
                )
            )
