...
from luicode.core.openai_responses.native import (
...
def test_native_request_preserves_reasoning_when_luicode_did_not_override_it() -> None:
    request = OpenAIResponsesRequest.model_validate(
        {
            "model": "gateway-model",
            "input": "hello",
...
def test_native_request_applies_luicode_reasoning_override(
    reasoning: ReasoningPolicy,
