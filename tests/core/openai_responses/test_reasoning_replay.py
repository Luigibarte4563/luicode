...
@pytest.mark.parametrize(
    ...
    [
        "openai-opaque",
        "luicode:anthropic-reasoning:v2:e30",
        "luicode:anthropic-reasoning:v1:!bad",
        "luicode:anthropic-reasoning:v1:e30",  # empty JSON object
        "luicode:anthropic-reasoning:v1:W10",  # JSON array
    ],
)
...
def test_missing_signature_is_not_accepted_as_signed_history() -> None:
    ...
    carrier = (
        "luicode:anthropic-reasoning:v1:"
