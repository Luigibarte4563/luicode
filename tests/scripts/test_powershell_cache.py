...
Get-Command luicode_nonexistent_cache_probe_command -ErrorAction SilentlyContinue
$deadline = [DateTime]::UtcNow.AddSeconds(20)
while (-not (Test-Path -LiteralPath $env:LUICODE_TEST_WATCHED_CACHE) -and [DateTime]::UtcNow -lt $deadline) {
