...
from luicode.runtime.application import RestartCallback
...
async def test_supervisor_drains_admin_event_feed_without_forced_cancellation(
    ...
    monkeypatch.setattr(
        "luicode.runtime.bootstrap.configure_logging",
        lambda *args, **kwargs: None,
    )
    monkeypatch.setattr("luicode.runtime.bootstrap.build_asgi_app", create_app)
