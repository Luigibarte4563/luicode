...
from luicode.cli.launchers.dsh_config import build_dsh_launch_config
...
def test_dsh_config_pins_responses_models_retries_and_private_state(
    ...
    provider = llm["config"]["providers"]["luicode"]
    assert provider == {
        "displayName": "luicode",
        "apiKeyEnv": "LUICODE_DSH_API_KEY",
...
def test_dsh_config_rounds_fractional_progress_timeout_up() -> None:
    ...
    provider = _row_by_id(launch, "llm-pi-ai")["config"]["providers"]["luicode"]
