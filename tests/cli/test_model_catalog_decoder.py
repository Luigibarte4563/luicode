...
def test_client_models_keep_no_thinking_direct_route() -> None:
    models = catalog_models_from_response(
        {
            "data": [
                {
                    "id": "claude-3-luicode-no-thinking/nvidia_nim/provider-model",
    ...
    assert models == (
        CatalogModel(
            wire_slug="claude-3-luicode-no-thinking/nvidia_nim/provider-model",
            provider_model_ref="nvidia_nim/provider-model",
            display_name="Display 0",
    ...
    assert catalog_models_from_response(
        {
            "data": [
                {
                    "id": "claude-3-luicode-no-thinking/open_router/plain-model",
    ...
    models = catalog_models_from_response(
        {
            "data": [
                ...
                {
                    "id": "claude-3-luicode-no-thinking/provider/unknown",
