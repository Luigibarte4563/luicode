...
from luicode.cli import desktop_entrypoint
from luicode.cli.desktop_assets import app_icon_bytes, export_app_icon
...
def test_desktop_entrypoint_rejects_unknown_arguments(
    ...
    assert "Usage: luicode-desktop" in capsys.readouterr().err
...
def test_desktop_sets_scaling_before_importing_native_tray(monkeypatch):
    ...
    def import_module(name, *args, **kwargs):
        if name == "luicode.cli.desktop_tray":
