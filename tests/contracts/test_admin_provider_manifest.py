...
from luicode.config.admin.manifest import FIELD_BY_KEY, FIELDS
from luicode.config.admin.state import ConfigValueState
...
def test_openai_proxy_override_applies_to_catalog_proxy_field() -> None:
    ...
    assert "restarts LUICODE" in entry.description
...
def test_provider_catalog_display_names_are_admin_status_source() -> None:
    ...
    from luicode.config.admin.values import load_value_state
