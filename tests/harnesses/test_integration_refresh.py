...
from luicode.harnesses import claude_integration, codex_integration
...
def test_refresh_codex_merges_latest_settings_without_changing_model(tmp_path):
    ...
    assert saved["model_providers"]["luicode"]["auth"] == {
...
@pytest.mark.parametrize(
    ...
    [
        None,
        "",
        OLD_CODEX.replace('model_provider = "luicode"', 'model_provider = "other"'),
